...
new Vue({
    ...
    created() {
        ...
        const errorWarningCount = errorCount + errorCount;
        ...
        Object.assign(this.analysis, {
            ...
            warningCount,
            fixableCount,
            fileCount: `${fileCount} (<span class="color-success">${fileCount - successFileCount}</span>/<span class="color-danger">${successFileCount}</span>)`
        });
    }
});
</script>
