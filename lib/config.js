...
const { Modal, List, Typography, Button, Tag, Tooltip, message } = antd
const { last, map, filter, remove, sum, isString, sortBy, flatten, intersection, groupBy, uniq } = _
...
export const hasNoError = !RankMessages.some(v => v.severity === 2)
