...
import { map, filter, sum, sortBy, flatten, intersection, groupBy, uniq } from 'lodash-es'
...
const {
  EslintResults,
  EslintRulesMeta,
  EslintCwd = 'eslint-formatter-html',
...
export { EslintCwd, EslintCreateTime, EslintPkg }
...
export const renderPkgInfo = () => {
  const { homepage, author, bugs } = EslintPkg
  const infoList = [
    {
      icon: <GithubOutlined />,
      href: homepage,
